...
export const dict = {
  ...
  "settings.extensions.tab.codex": "Codex",
  ...
  "settings.extensions.codex.title": "Available from Codex",
  "settings.extensions.codex.description":
    "Import compatible skills and standard MCP servers from the local Codex plugin cache. ChatGPT-hosted apps and hooks remain visible but require their original host.",
  "settings.extensions.codex.search": "Search Codex plugins",
  "settings.extensions.codex.empty": "No Codex plugins were found on this machine.",
  "settings.extensions.codex.feature.skills": "Skills",
  "settings.extensions.codex.feature.mcp": "MCP",
  "settings.extensions.codex.feature.app": "ChatGPT app",
  "settings.extensions.codex.feature.hooks": "Hooks",
  "settings.extensions.codex.install": "Install",
  "settings.extensions.codex.installed": "Installed",
  "settings.extensions.codex.requiresChatGPT": "Requires ChatGPT",
  "settings.extensions.codex.installedToast": "Installed {{plugin}} from Codex",
